                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function($model){
                            ...
                            foreach (\ityakutia\rbac\models\RoleForm::getRolePermissions($model['name']) as $key => $permission) {
                                $permissionsAndRoles .= '<div class="chip">'.$permission->description.'</div>';
                            }
                            $permissionsAndRoles .= '<p>Дочерние роли</p>';
                            foreach (\ityakutia\rbac\models\RoleForm::getChildRoles($model['name']) as $key => $roles) {
