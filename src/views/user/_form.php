...
?>
    ...
    <?php
        $list = ArrayHelper::map(\ityakutia\rbac\models\RoleForm::allAsArray(),'name','description');
        $setted_roles = \ityakutia\rbac\models\AssignmentForm::getUserAssignments($user->id);
